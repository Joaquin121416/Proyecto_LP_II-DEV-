...
public class InsumoServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(opc) {
		case "lis": listarInsumo(request,response);break;
		case "fil": filtrarInsumo(request,response);break;
		case "reg": registrarInsumo(request,response);break;
		case "act": actualizarInsumo(request,response);break;
		case "eli": eliminarInsumo(request,response);break;
		}
	}
	...
	private void registrarInsumo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	private void filtrarInsumo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String mensaje = "", url;
		int tipo = Integer.parseInt(request.getParameter("cboTipoInsumo"));
		
		Factory fabrica = Factory.getTipo(Factory.TIPO_MYSQL);
		InsumosDAO dao = fabrica.getInsumoDAO();
		ArrayList<InsumosDAO> lista = dao.listarInsumos();
