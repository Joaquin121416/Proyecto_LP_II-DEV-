...
<body data-spy="scroll" data-target=".site-navbar-target"
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-11 col-xl-2 site-logo">
					<h1 class="mb-0">
						<a href="Index.jsp" class="text-white h2 mb-0">Empresa</a>
					</h1>
				</div>
				<div class="col-12 col-md-10 d-none d-xl-block">
					<nav class="site-navigation position-relative text-right"
						...
						<ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
							...
							<li class="has-children"><a href="#section-about"
								class="nav-link">Acerca de Nosotros</a>
								<ul class="dropdown">
									<li><a href="#section-how-it-works" class="nav-link">Como
											Trabajamos </a></li>
									<li><a href="#section-our-team" class="nav-link">
											Nuestro Equipo</a></li>
								</ul></li>
			...
			<div
				...
				<div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
					...
					<h1
						...
						data-aos="fade-up">Proyecto Java Web</h1>
	...
	<div class="site-section" id="section-about">
		<div class="container">
			<div class="row mb-5">
				...
				<div class="col-md-5 ml-auto mb-5 order-md-2" data-aos="fade-up"
					data-aos-delay="100">
				...
				<div class="col-md-6 order-md-1" data-aos="fade-up">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
						...
						modi rem, vero eos ipsam voluptas.</p>
					<p class="mb-5">Error minus sint nobis dolor laborum
						architecto, quaerat. Voluptatum porro expedita labore esse velit
						veniam laborum quo obcaecati similique iusto delectus quasi!</p>
	...
	<div class="site-section bg-image overlay"
		style="background-image: url('resources/images/hero_bg_4.jpg');"
					...
					<div class="how-it-work-item">
						...
						<div class="how-it-work-body">
							...
							<p class="mb-5">Lorem ipsum dolor sit amet consectetur
								adipisicing elit. Incidunt praesentium dicta consectetur fuga
								neque fugit a at. Cum quod vero assumenda iusto.</p>
							<ul class="ul-check list-unstyled success">
								<li class="text-white">Error minus sint nobis dolor</li>
								<li class="text-white">Voluptatum porro expedita labore
									esse</li>
				...
				<div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade"
					...
					<div class="person">
						<img src="resources/images/person_1.jpg" alt="Image"
							class="img-fluid rounded mb-5 w-75 rounded-circle">
		...
		<div class="container">
			...
			<div class="row align-items-stretch">
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
					<div class="unit-4 d-flex">
						<div class="unit-4-icon mr-4">
							<span class="text-primary flaticon-plane"></span>
						</div>
						<div>
							<h3>Air Freight</h3>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4 d-flex">
						<div class="unit-4-icon mr-4">
							<span class="text-primary flaticon-boat-ship"></span>
						</div>
						<div>
							<h3>Ocean Freight</h3>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4 d-flex">
						<div class="unit-4-icon mr-4">
							<span class="text-primary flaticon-truck"></span>
						</div>
						<div>
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4 d-flex">
						<div class="unit-4-icon mr-4">
							<span class="text-primary flaticon-warehouse"></span>
						</div>
						<div>
							<h3>Warehousing</h3>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4 d-flex">
						<div class="unit-4-icon mr-4">
							<span class="text-primary flaticon-wooden"></span>
						</div>
						<div>
							<h3>Storage</h3>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"
					...
					<div class="unit-4 d-flex">
						<div class="unit-4-icon mr-4">
							<span class="text-primary flaticon-worldwide"></span>
						</div>
						<div>
		...
		<div class="container">
			...
			<div class="slide-one-item home-slider owl-carousel">
				...
				<div>
					<div class="testimonial">
						<figure class="mb-4">
							<img src="resources/images/person_5.jpg" alt="Image"
								class="img-fluid mb-3">
						</figure>
						<blockquote>
							<p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing
				...
				<div class="col-md-12">
					<div class="border-top pt-5">
						<p>
							...
							</script> Logis Free Template. All Rights Reserved. <br> Designed
								&amp; Developed by <a href="https://free-template.co/"
