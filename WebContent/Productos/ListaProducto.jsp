					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="card">
								...
								<form action="crudProducto"
										enctype="multipart/form-data">
									<div class="card-body">
									
									
									<display:table  clearStatus="" summary=""  class="table" name="${ listaProducto }" pagesize="10" export="false" decorator="com.sistema.comidas.util.Wrapper">
...
>>>>>>> 8bb335294bf900a52e7fb0045110c690017c89ba
	<!-- /#right-panel -->
>>>>>>> 1636fecc92763ce1854ae0cd65ec7e4e4ea58853
