	...
	<header>
		<nav id="nav" class="nav1">
			<div class="contenedor-nav">
				<div class="logo">
					<img src="https://image.shutterstock.com/image-vector/menu-spoon-fork-icon-vector-260nw-631389242.jpg">
				</div>
		...
		<div class="textos">
			...
			<div class="btn-carta"  id="enlace-clientes2"><a href="#">VER SISTEMAS</a></div>
		</div>
	</header>
	<main>
