							...
							<div class="card">
								...
								<form action="/LP_2_Sistema_Venta_3.0/ProveedorServlet"
									...
									<div class="card-body card-block">
										...
										<div class="row form-group">
											<div class="col col-md-3">
												<label for="textarea-input" class=" form-control-label">Telefono
													:</label>
											</div>
											<div class="col-12 col-md-9">
									...
									<class="form-horizontal">
										<div class="row form-group">
											<div class="col col-md-3">
												...
												<label class=" form-control-label">Sesion de auditoria :</label>
											</div>
											<div class="col-12 col-md-9">
												<input type="text" id="disabled-input" name="cod"
													 class="form-control" readonly="true" value="${cod}">
										...
										<div class="row form-group">
											<div class="col col-md-3">
												...
												<label class=" form-control-label">Fecha sesion :</label>
											</div>
											<div class="col-12 col-md-9">
												<input type="datetime" id="disabled-input" name="cod"
													 class="form-control" readonly="true" value="${cod}">
										...
										<div class="row form-group">
											<div class="col col-md-3">
												...
												<label class=" form-control-label">Codigo auditoria :</label>
											</div>
											<div class="col-12 col-md-9">
												<input type="text" id="disabled-input" name="cod"
													 class="form-control" readonly="true" value="${cod}">
